...
<head>
    ...
    <title>Wellv auto center&copy; | Principal </title>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Bem-vindo a <strong>Wellv auto center&copy;</strong></span>
                        </li>
                        <li>
                            <a href="index.html">
                            ...
                            <form class="form-horizontal" method="POST" enctype="multipart/form-data" action="parametrosg.php">
                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-3">
                                                <input id="cdprop" name="cdprop"  data-mask-for-cpf-cnpj value="<?php echo $aPara[0]["cdprop"]; ?>" type="text" placeholder="" class="form-control" maxlength = "14" autofocus>
                                            </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="demail" name="demail" value="<?php echo $aPara[0]["demail"]; 
                                                $aPara[0]["demail"] = filter_var($aPara[0]["demail"], FILTER_SANITIZE_EMAIL);
                                                
                                                ?>" 
                                                type="text" placeholder="" class="form-control" maxlength = "255">
                                            </div>
                                        </div>
