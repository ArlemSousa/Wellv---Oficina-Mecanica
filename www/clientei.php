...
<head>
    ...
    <title>WELLV&copy; | Principal </title>
            ...
            <div class="row border-bottom">
                <nav class="navbar navbar-static-top white-bg" role="navigation" style="margin-bottom: 0">
                    ...
                    <ul class="nav navbar-top-links navbar-right">
                        <li>
                            <span class="m-r-sm text-muted welcome-message">Bem-vindo a <strong>WELLV&copy;</strong></span>
                        </li>
                        <li>
                            <a href="index.html">
                                ...
                                <div class="row">
                                    <!--div class="col-lg-6"-->
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-2">
                                                <input id="nrcepi" name="nrcepi" value="" onblur="pesquisacep(this.value);" type="text" placeholder="" class="form-control" maxlength = "08" autofocus required="">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-8">
                                                <input id="demail" name="demail" value="" type="email" placeholder="seuemail@seuprovedor.com.br" class="form-control" maxlength = "255" autofocus required="">
                                            </div>
                                        </div>
